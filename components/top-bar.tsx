    ...
    <>
      ...
      {uploading && (
        <div className="fixed inset-0 bg-background/50 backdrop-blur-xs z-50 flex items-center justify-center p-4">
          <div 
            className="bg-card/90 border border-white/10 p-6 rounded-2xl w-full max-w-sm shadow-[0_12px_40px_rgba(0,0,0,0.6)] backdrop-blur-md space-y-5 animate-in fade-in zoom-in-95 duration-200"
          >
            <div className="space-y-1">
              ...
              <p className="text-muted-foreground/60 text-[10px]">Processing and mapping database aggregates...</p>
            </div>
            ...
            <div className="space-y-1.5">
              <div className="w-full bg-muted/80 h-1.5 rounded-full overflow-hidden">
                <div 
                  className="bg-accent h-full transition-all duration-500 rounded-full shadow-[0_0_8px_rgba(0,212,255,0.4)]"
