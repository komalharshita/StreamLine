...
@router.get("/dashboard", summary="Retrieve aggregated business intelligence dashboard state")
def get_dashboard(
...
def get_business_health(
    ...
    return {
        ...
        "status": "healthy" if health_data.get("health_score", 100) >= 70 else "warning",
    }
